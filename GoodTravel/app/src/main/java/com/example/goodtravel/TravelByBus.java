 ...
 * Use the {@link TravelByBus#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TravelByBus extends Fragment {
    RecyclerView rv;
    ArrayList<Travel> lt;
    TravelsAdapter ta;
     ...
     * @return A new instance of fragment TravelByBus.
     */
    // TODO: Rename and change types and number of parameters
    public static TravelByBus newInstance(String param1, String param2) {
        TravelByBus fragment = new TravelByBus();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout= inflater.inflate(R.layout.fragment_travel_by_bus, container, false);
        ...
        travelfilter.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                String url;
                if(filter.equals("")){
                    url = "http://"+globalvariable.ip+"/GoodTravelAppApi/travelsapi.php?outile=bus&vd=all";
                }
                else{
                    url = "http://"+globalvariable.ip+"/GoodTravelAppApi/travelsapi.php?outile=bus&vd="+filter;
                }
        ...
        final String[] myresponse = new String[1];
        OkHttpClient client = new OkHttpClient();
        String url = "http://"+globalvariable.ip+"/GoodTravelAppApi/travelsapi.php?outile=bus&vd=all";
        okhttp3.Request request = new okhttp3.Request.Builder().url(url).build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
